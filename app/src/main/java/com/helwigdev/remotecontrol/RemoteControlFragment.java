package com.helwigdev.remotecontrol;
...
public class RemoteControlFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		mSelectedTextView = (TextView) v.findViewById(R.id.tv_fragment_remote_control_selected);
		mWorkingTextView = (TextView) v.findViewById(R.id.tv_fragment_remote_control_working);
		...
		TableLayout tableLayout = (TableLayout) v.findViewById(R.id.tl_fragment_remote_control);
		int number = 1;
